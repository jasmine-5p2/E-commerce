...
const products = [
  {
    ...
    price: 34.99,
    image: "https://sp.yimg.com/ib/th?id=OPAC.Wu6Uot1RxyEtrA474C474&o=5&pid=21.1&w=160&h=105",
    rating: 4.6,
...
const CasualFootwear = () => {
  ...
  return (
    <div className="container py-5" style={{ maxWidth: 1200 }}>
      <h2 style={{ fontWeight: 700, marginBottom: 8 }}>Casual Footwear</h2>
      <p style={{ color: "#555", marginBottom: 24 }}>Discover comfortable and stylish casual shoes for everyday wear.</p>
